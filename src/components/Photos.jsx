    ...
    <div style={{ backgroundColor: '#f6edd6' }}>
      ...
      <div className='swim-div'>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt minima id doloremque, deserunt, eligendi ad, nemo nihil voluptatem obcaecati exercitationem debitis dolorem enim rerum cumque! Quam animi qui dolor laborum.</p>
          ...
          <motion.img ref={swimLessonRef}
            ...
            animate={swimLessonInView ? { maskImage: 'repeating-linear-gradient(90deg, black 0%, black 100%, transparent 100%, transparent 100%)' } : {}}
      ...
      <div className='group'>
        ...
        <motion.img ref={diveRef}
          ...
          initial={{ maskImage: 'repeating-linear-gradient(90deg, black 0%, black 0%, transparent 0%, transparent 100%)' }}
          animate={diveInView ? { maskImage: 'repeating-linear-gradient(90deg, black 0%, black 100%, transparent 100%, transparent 100%)' } : {}}
